...
def leeRivales():
    ...
    cm = ConfigMotor("komodo", "Don Dailey, Larry Kaufman", "8", "http://komodochess.com/")
    cm.path = "Linux/komodo-8-linux-generic"
    cm.ordenUCI("Ponder", "false")
    cm.ordenUCI("Hash", "32")
    cm.elo = 3053
    cm.ponMultiPV(20, 99)
    ...
    cm = ConfigMotor("mcbrain", "Michael Byrne (based on stockfish)", "2.1a", "https://github.com/MichaelB7/Stockfish/releases")
    cm.path = "McBrain_2017_v21a_x64_linux"
    cm.elo = 3200
